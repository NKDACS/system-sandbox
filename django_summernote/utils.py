...
SUMMERNOTE_THEME_FILES = {
    'bs3': {
        ...
        'base_js': (
            '' if settings.DEBUG else settings.PRODUCTION_URL_PREFIX + '/static/summernote/jquery-3.3.1.min.js',
    ...
    'bs4': {
        'base_css': (
            '' if settings.DEBUG else settings.PRODUCTION_URL_PREFIX + '/static/summernote/bootstrap.min.css',
        ),
        'base_js': (
            '' if settings.DEBUG else settings.PRODUCTION_URL_PREFIX + '/static/summernote/jquery-3.3.1.min.js',
            '' if settings.DEBUG else settings.PRODUCTION_URL_PREFIX + '/static/summernote/bootstrap.bundle.min.js',
        ),
        'default_css': (
